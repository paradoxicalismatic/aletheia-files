...
<head>
    ...
    <style>
        ...
        .change-list li {
            position: relative;
            padding-left: 1.5rem;        <div class="button-container">
...
<li class="improved">Major UI change</li>
</ul>
</div>
...
<ul class="change-list">
<li class="improved">Improved the UI of pm's and of the main chat.</li>
</ul>
</div>
...
<ul class="change-list">
<li class="added">Added two new themes: Whitenblack (white background, black text) and Blacknwhite (pure black background, white text).</li>
<li class="improved">Renamed the Metal theme to Cyberpunk.</li>
<li class="improved">Revamped the default theme.</li>
<li class="fixed">Fixed database issues</li>
</ul>
</div>
...
<ul class="change-list">
<li class="fixed">Fixed text going off screen in settings.</li>
<li class="improved">Made the dropdownmenus and profile viewing pages terminal-styled</li>
<li class="added">The state of opened settings/online users is now saved, when you refresh or log in again, the previous state is loaded </li>
...
<ul class="change-list">
<li class="improved">Deleting a message (and kicking) doesn't refresh the whole page anymore :]]</li>
<li class="improved">Input box now gets auto-selected after sending a message. [YIPPEEEE]</li>
<li class="improved">No message cooldown for Senior member and up.</li>
</ul>
</div>
