        ...
        <div class="rules-list">
            <div class="rule-item">
                ...
                <div class="rule-content">
                    <h2 class="rule-title">No CSAM. Zero tolerance.</h2>
            ...
            <div class="rule-item">
                ...
                <div class="rule-content">
                    <h2 class="rule-title">No scamming</h2>
                    <p class="rule-description">No scamming. Fraud, phishing, or linking to scam sites isn't.</p>
                </div>
            </div>
            ...
            <div class="rule-item">
                ...
                <div class="rule-content">
                    ...
                    <p class="rule-description"> Repeated messages or mass promotion isn't allowed.</p>
                </div>
            </div>
