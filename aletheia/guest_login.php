...
if (LOCKDOWN_ENABLED) {
    $error = 'The site is currently in lockdown mode. Guest logins are temporarily disabled.';
...
<head>
    ...
    <title>Guest Login - <?= SITE_NAME ?></title>
...
<body>
    <div class="auth-container">
        ...
        <form method="POST" novalidate>
            <input type="text" name="username" placeholder="Username" required <?= LOCKDOWN_ENABLED ? 'disabled' : '' ?>>
            <input type="password" name="password" placeholder="Password" required <?= LOCKDOWN_ENABLED ? 'disabled' : '' ?>>

            <div class="captcha-box">
                <img src="captcha_image.php" alt="CAPTCHA Image">
                <input type="text" name="captcha" placeholder="Enter CAPTCHA" required autocomplete="off" <?= LOCKDOWN_ENABLED ? 'disabled' : '' ?>>
            </div>

            <button type="submit" <?= LOCKDOWN_ENABLED ? 'disabled' : '' ?>>Login</button>
        </form>
        <p>No account? <a href="register.php">Register here</a></p>
        <p>Are you a member? <a href="member_login.php">Login here</a></p>
